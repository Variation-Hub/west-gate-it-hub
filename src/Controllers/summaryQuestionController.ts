...
export const createSummaryQuestion = async (req: any, res: Response) => {
    try {
        let { questionName, question, instructions, refrenceDocument, weightage, deadline, projectId } = req.body


        const summaryQuestion = await summaryQuestionModel.create({ questionName, question, instructions, refrenceDocument, weightage, deadline, projectId })
...
export const updateSummaryQuestion = async (req: Request, res: Response) => {
    try {
        ...
        let { questionName, question, instructions, refrenceDocument, weightage, deadline } = req.body
