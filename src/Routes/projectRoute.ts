...
projectRoutes.get("/search", authorizeRoles(), searchProjectsByName);
...
projectRoutes.delete("/delete/approve-reject-admin/:id", authorizeRoles(), deleteAdminStatusComment);
